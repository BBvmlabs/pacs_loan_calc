...
class _LoanDetailsState extends State<LoanDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: buildAppBar("Loan Details", context),
                  ...
                  TableRow(children: [
                    Padding(
                        padding: const EdgeInsets.only(
                            left: 25.0, right: 80.0, top: 5.0),
                        child: CustomButton(
                          buttonHeight: 50,
                          buttonWidth: 70,
                          onClicked: () {
                            Navigator.pushNamed(context, "/file-saved?false");
                          },
                    ...
                    Padding(
                        ...
                        child: CustomButton(
                          onClicked: () {
                            Navigator.pushNamed(context, '/file-saved?true');
                          },
                          text: "Proceed",
